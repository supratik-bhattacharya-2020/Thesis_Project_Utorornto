...
import random
'''
delete the previous cube and then run this script, then go to shading and do the setting up of pbr materials as directed in the dataset_creation.. file
'''
...
white_shader = all_nodes.new('ShaderNodeBsdfDiffuse')
white_shader.inputs[0].default_value = (0.800000011920929, 0.800000011920929, 0.800000011920929, 1.0)
white_shader.location = (400,-300)
black_shader = all_nodes.new('ShaderNodeBsdfDiffuse')
black_shader.inputs[0].default_value = (0.0, 0.0, 0.0, 1.0)
black_shader.location = (400,-700)
